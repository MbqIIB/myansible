...
perl -pi -e "s/^rabbit_hosts.*$/rabbit_hosts=$NEW_PREFIXn1:5672,$NEW_PREFIXn2:5672,$NEW_PREFIXn3:5672/g" /etc/nova/nova.conf
...
perl -pi -e "s/^rabbit_hosts.*$/rabbit_hosts=$NEW_PREFIXn1:5672,$NEW_PREFIXn2:5672,$NEW_PREFIXn3:5672/g" /etc/neutron/neutron.conf
...
perl -pi -e "s/^rabbit_hosts.*$/rabbit_hosts=$NEW_PREFIXn1:5672,$NEW_PREFIXn2:5672,$NEW_PREFIXn3:5672/g" /etc/cinder/cinder.conf
...
perl -pi -e "s/^#rabbit_hosts.*$/rabbit_hosts=$NEW_PREFIXn1:5672,$NEW_PREFIXn2:5672,$NEW_PREFIXn3:5672/g" /etc/heat/heat.conf
