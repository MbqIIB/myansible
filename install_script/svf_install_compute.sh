...
#scp 192.168.33.2:/home/zhuchao/install/nova-docker-alchemy-20160405.tar.gz /home/install/

scp -r svf3:/home/install/nova-docker-alchemy/ /home/install/

#cd /home/install
#tar xzf nova-docker-alchemy.tar.gz
#tar xzf nova-docker-alchemy-20160405.tar.gz

cd /home/install/nova-docker-alchemy/nova-docker/
pip install .
...
scp svf3:/usr/lib/python2.7/dist-packages/nova/objects/compute_node.py   /usr/lib/python2.7/dist-packages/nova/objects/compute_node.py
scp svf3:/usr/lib/python2.7/dist-packages/nova/compute/resource_tracker.py /usr/lib/python2.7/dist-packages/nova/compute/resource_tracker.py


scp svf3:/usr/lib/python2.7/dist-packages/nova/compute/capi_states.py     /usr/lib/python2.7/dist-packages/nova/compute/
scp svf3:/usr/lib/python2.7/dist-packages/nova/compute/sdaccel_states.py  /usr/lib/python2.7/dist-packages/nova/compute/
scp svf3:/usr/lib/python2.7/dist-packages/nova/compute/gpu_states.py      /usr/lib/python2.7/dist-packages/nova/compute/
